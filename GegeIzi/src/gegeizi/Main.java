...
public class Main extends Application {
    ...
    Keyboard mainKeyboard; //UI element that will hold and process all the 
    ...
    String[] instruments; //Holds a list of all instruments available
    ...
    public void start(Stage primaryStage) {
        ...
        //instruments = {"Piano", "Percussion", "Tuba", "Ocarina"};

        Image j = new Image(getClass().getResourceAsStream("UrfDisk.png"));
        spinning = new ImageView(j);
        spinning.relocate(100, 100);//sets up the spinning disk
        ...
        Button stopThis = new Button("Stop");//Stop button for doing stopping stuff
        stopThis.setFont(new Font("Cambria",14));
        ...
        root.getChildren().addAll(mainKeyboard,pickMatches,spinning,btn,inTempo,elTempo,elList,allBoxes,songPlaying,getInfo,stopThis);
