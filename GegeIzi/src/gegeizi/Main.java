...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        String[] instruments = {"Acoustic Grand Piano", "Bright Grand Piano", "Xylophone", "Gunshots", "Honky-tonk Piano", "Melodic Drum", "Harpsicord"};
        ...
        root.getChildren().addAll(mainKeyboard,pickMatches,pickInstrument,spinning,btn,inTempo,elTempo,elList,allBoxes,songPlaying,getInfo,stopThis);
