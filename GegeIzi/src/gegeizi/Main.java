...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        String[] instruments = {"Piano", "Percussion", "Tuba", "Ocarina"};
        ...
        Rectangle getInfo = new Rectangle(690, 70, 32, 32);
        ImagePattern s = new ImagePattern(im);
        getInfo.setFill(s);
        
        getInfo.setOnMouseClicked((MouseEvent e)->{
        ...
        root.getChildren().addAll(mainKeyboard,pickMatches,spinning,btn,inTempo,elTempo,elList,allBoxes,songPlaying,getInfo);
